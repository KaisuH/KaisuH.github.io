...
/* Example positions */
.node:nth-child(1) { top: 10%; left: 20%; animation-duration: 6s; }
.node:nth-child(2) { top: 50%; left: 60%; animation-duration: 4s; }
.node:nth-child(3) { top: 80%; left: 30%; animation-duration: 7s; }


/*DNa bouncing animation*/
...
.dna-animation {
  ...
  height: auto;
  opacity: 0.3;
  animation: moveDNA 6s infinite ease-in-out;
}
</style>
```
...
<div class="container" style="margin-top: 40px;">
  ...
  <div id="about" class="row">
    <div class="col-md-12">
      ...
      <p><h4>Msc Bioinformatics and Digital Health</h4>
        ...
        I am fascinated by how genetics, artificial intelligence, and bioinformatics help us uncover the mechanisms that shape who we are and how we function. These fields offer a deeper look into the complexities of biology - peering into the molecular engine of life.  </p>
        
      <p> What excites me most is their potential to solve real-world problems and improve lives. From advancing personalized medicine to accelerating drug discovery, these technologies hold the key to tackling some of the biggest challenges in healthcare and beyond. I am particularly motivated by the idea that by decoding biological data and leveraging AI, we can make discoveries that alleviate suffering and drive meaningful progress in science and medicine. </p>
      </p>
    </div>
 </div> 
  ...
  <div id="projects" class="row" style="margin-top: 30px;">
    <div class="col-md-12"> 
      <h2>Projects</h2>
        Below are some of the projects I maintain on GitHub. 
        Click the headers to learn more:
      </p>
      <h4><a href="https://kaisuh.github.io/Emotion-AI/">Emotion AI</a></h4>
      <ul>
...
<!-- Section for Education -->
  <div id="education" class="row" style="margin-top: 30px;">
    <div class="col-md-12">
      <h2>Education</h2>
      ...
      <p>  My master’s program combined advanced studies in biology, data science, and digital health technologies. I gained expertise in analyzing complex biological data, developing computational models, and applying digital solutions to improve healthcare outcomes. This interdisciplinary training provided me with the tools to bridge the gap between technology and life sciences. 
      </p>
      ...
      <p>During my bachelor’s studies, I developed a strong foundation in computer science, engineering, and biology. The curriculum emphasized the integration of information technology with biological research, equipping me with essential skills in data analysis, programming, and problem-solving in the context of life sciences.</p>
    </div>
  </div>
