...
<body>
    ...
    <script>
        ...
        Image Credit: <a href="https://www.flickr.com/photos/23095866@N03/6978007064" target="_blank">John P Clare (Flickr)</a>, used under <a href="https://creativecommons.org/licenses/by-nc-nd/2.0/" target="_blank">CC BY-NC-ND 2.0</a>.`
            ...
            { question: "AI can discover new antibiotics effective against drug-resistant bacteria.", answer: true,
explanation: `For example, in 2019, MIT researchers trained a neural network on a data set of 2335 molecules to learn which ones inhibited the growth of <em>E. coli</em>. They then applied it to multiple chemical libraries comprising over 107 million molecules, ranked the candidates by the model's predicted score, and selected the most promising ones. This surfaced <a href="https://www.cell.com/cell/fulltext/S0092-8674(20)30102-1" target="_blank">halicin</a>, a molecule originally developed as a diabetes drug but abandoned after poor results. Halicin was named as a direct homage to HAL 9000, the fictional, hyper-intelligent AI from the 1968 sci-fi film <em>2001: A Space Odyssey</em>.`},
